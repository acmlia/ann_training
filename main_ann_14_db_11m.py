...
from src.training_ann_14 import Training
...
#------------------------------------------------------------------------------
    pred = Prediction(random_seed=7,
                      version='NOV14',
                      file_csv='regional_2014-11_clip-br_all_input_SCR02.csv',
